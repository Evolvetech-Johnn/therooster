  ...
  if (cartItems.length === 0) {
    return (
      <div className="container cart-empty">
        ...
        <Link to="/catalogo" className="btn btn-primary">Ver Cardápio</Link>
      </div>
    );
  }
      ...
      <div className="cart-content">
          ...
          {cartItems.map(item => (
            <div key={item.cartId || item.id} className="cart-item">
              ...
              <div className="item-actions">
                ...
                <button className="remove-btn" onClick={() => removeFromCart(item.cartId || item.id)} aria-label="Remover">
                  <Trash2 size={20} />
                </button>
              </div>
            </div>
        ...
        <div className="cart-summary">
          ...
          <div className="coupon-section">
              ...
              {couponMessage && (
                  <p className={`coupon-msg ${couponMessage.type}`}>{couponMessage.text}</p>
              )}
          </div>
          ...
          <button className="btn btn-primary btn-full checkout-btn" onClick={() => navigate('/checkout')}>
            Finalizar Pedido
          </button>
